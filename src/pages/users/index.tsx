        ...
        <Box flex="1" borderRadius={8} bg="gray.800" p="8">
          ...
          >
            ...
            <Link href="/users/create" passHref>
              <Button as="a" size="sm" fontSize="sm" colorScheme="pink" leftIcon={<Icon
                as={RiAddLine} />}>
                Criar novo
              </Button>
            </Link>
              ...
              <Tr>
                ...
                <Td>
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.300">diegoshel@gmail.com</Text>
                  </Box>
                </Td>
                {isWideVersion && <Td>04 de Abril de 2021</Td>}
                <Td><Button as="a" size="sm" fontSize="sm" colorScheme="purple" leftIcon={<Icon
                  as={RiPencilLine} />}>
                  Editar
                </Button></Td>
              </Tr>
